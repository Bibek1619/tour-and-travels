...
const defaultContent = {
  ...
  intro: {
    ...
    description1: 'Adventure Nepal is a leading travel agency and destination management company in Nepal with over 26+ years of experience. We specialize in bringing you the wonders of "Incredible Nepal" – a country that has captivated travelers for centuries.',
    description2: 'Embark on an unforgettable journey through Nepal\'s diverse landscapes, from the snow-capped peaks of the Himalayas to lush valleys, ancient temples, and vibrant cities. Our expertly crafted tours showcase Nepal\'s rich culture, heritage, wildlife, and spirituality while surprising you with its modern developments.',
    description3: 'Experience the warm hospitality of Nepali people, explore UNESCO World Heritage Sites, trek through pristine mountain trails, and immerse yourself in colorful festivals and traditions. Whether you seek adventure, spirituality, or cultural enrichment, Nepal offers an experience that will transform you.',
  ...
  whyUs: {
    ...
    description: 'We provide comprehensive travel solutions with the highest standards of safety, comfort, and customer service in Nepal — from planning to the road, we\'ve got you covered.',
