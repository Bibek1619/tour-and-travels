                ...
                <div className="border-b">
                  <div className="flex overflow-x-auto">
                    {["overview", "itinerary", "included", "excluded", "guide"].map((tab) => (
                      ...
                      >
                        {tab === "guide" ? "Guide" : tab.charAt(0).toUpperCase() + tab.slice(1)}
                      </button>
                    ))}
                  </div>
                </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-white rounded-xl p-5 border border-orange-100 shadow-sm">
                          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-4">
                            ...
                            <div className="flex-1 text-center sm:text-left min-w-0">
                              <h3 className="text-lg font-bold text-gray-800 mb-1">Rajesh Sharma</h3>
                              <p className="text-orange-600 font-semibold text-sm mb-1">Senior Mountain Guide</p>
                              ...
                              <div className="flex gap-2 justify-center sm:justify-start">
                                ...
                                <a href="mailto:guide@adventurenepal.com"
                          ...
                          <div className="space-y-1.5 text-sm text-gray-700">
                            <p><strong className="text-gray-800">Specialization:</strong> High altitude trekking, Cultural tours</p>
                            <p><strong className="text-gray-800">Languages:</strong> English, Hindi, Nepali</p>
                            <p><strong className="text-gray-800">Certifications:</strong> Wilderness First Aid, Mountain Guide License</p>
                          </div>
                          <p className="text-gray-500 text-xs mt-3 italic">"I love sharing the beauty of Nepal with travelers from around the world."</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl p-5 border border-blue-100 shadow-sm">
                          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-4">
                            ...
                            <div className="flex-1 text-center sm:text-left min-w-0">
                              <h3 className="text-lg font-bold text-gray-800 mb-1">Suresh Gurung</h3>
                              <p className="text-blue-600 font-semibold text-sm mb-1">Certified Trekking Guide</p>
                              <p className="text-xs text-gray-500 mb-3">
                          ...
                          <div className="space-y-1.5 text-sm text-gray-700">
                            <p><strong className="text-gray-800">Specialization:</strong> Wildlife tours, Jungle safaris</p>
                            <p><strong className="text-gray-800">Languages:</strong> English, Nepali, Japanese</p>
                            <p><strong className="text-gray-800">Certifications:</strong> Eco-tourism Guide, First Aid Certified</p>
                          </div>
                          <p className="text-gray-500 text-xs mt-3 italic">"Born and raised in the mountains, I'm passionate about showing you the hidden gems of Nepal."</p>
                        </div>
                      </div>
